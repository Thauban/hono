...
```shell
    docker compose exec db bash
        psql --dbname=postgres --username=postgres --file=/init/soldat/sql/create-db.sql
        psql --dbname=soldat --username=soldat --file=/init/soldat/sql/create-schema.sql

        psql --dbname=soldat --username=soldat --file=/init/soldat/sql/create-table.sql
        psql --dbname=soldat --username=postgres --file=/init/soldat/sql/copy-csv.sql
        exit
    docker compose down
```
